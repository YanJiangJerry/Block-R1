#!/bin/bash
# Block-R1 + WD1 — per-sample br1_best_block_size from offline JSONL.

#SBATCH --job-name=block_r1_wd1
#SBATCH --nodes=1
...
export WANDB_PROJECT="${WANDB_PROJECT:-block_r1_wd1}"
...
RUN_NAME="${RUN_NAME:-block_r1_wd1_multi}"
NUM_ITER=12
