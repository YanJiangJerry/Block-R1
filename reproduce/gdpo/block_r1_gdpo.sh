#!/bin/bash
# Block-R1 + GDPO (per-sample br1_best_block_size from offline JSONL).

#SBATCH --job-name=block_r1_gdpo
#SBATCH --nodes=1
...
export WANDB_PROJECT=block_r1_gdpo
