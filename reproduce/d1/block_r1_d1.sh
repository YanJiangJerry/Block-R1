#!/bin/bash
# Block-R1 + D1 (DiffuGRPO / clipped GRPO) — per-sample br1_best_block_size from offline JSONL.

#SBATCH --job-name=block_r1_d1
#SBATCH --nodes=1
...
export WANDB_PROJECT="${WANDB_PROJECT:-block_r1_d1}"
...
RUN_NAME="${RUN_NAME:-block_r1_d1_multi}"
NUM_ITER=12
