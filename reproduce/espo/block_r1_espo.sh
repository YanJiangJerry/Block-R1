#!/bin/bash
# Block-R1 + ESPO (per-sample br1_best_block_size from offline JSONL).

#SBATCH --job-name=block_r1_espo
#SBATCH --nodes=1
...
export WANDB_PROJECT="${WANDB_PROJECT:-block_r1_espo}"
...
RUN_NAME="${RUN_NAME:-block_r1_espo_multi}"
NUM_ITER=12
