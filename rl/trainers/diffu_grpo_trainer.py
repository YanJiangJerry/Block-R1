"""
This code follows diffu grpo official implementation.
"""
...
class DiffuGRPOTrainer(GRPOTrainer):
    """
    The implementation from the d1 paper
    ...
    def _generate_and_score_completions(
        ...
        if self.control.should_evaluate:
            # Skip the normal evaluation metrics generation
            return {
                "prompt_ids": None,
                "prompt_mask": None,
                "completion_ids": None,
        ...
        with unwrap_model_for_generation(
            ...
            for i in range(0, prompt_ids.size(0), generation_batch_size):
                ...
                # R1/Block-R1 b1 variants keep trainer_type like "r1_b1_d1" (and Block-R1
                # scripts pass "br1_b1_d1" which run_block_r1 maps to "r1_b1_d1").
                # Use substring check so dynamic_generate is enabled for both.
                if "b1_d1" in str(self.args.trainer_type):
